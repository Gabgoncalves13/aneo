...
const audio = document.querySelector('audio#mauricio');
audio.style.display = "none"
audio.src = '../../assets/audio/mauricio_cap_1.mp3'
...
audio.addEventListener('timeupdate', ()=>{
    audioDeterminate.style.width = `${Math.floor(audio.currentTime) * .4901960784313725}%`
    const totalMinutes = Math.floor(audio.duration / 60);
    const totalSeconds = Math.floor(audio.duration % 60);        
...
const audiop = document.querySelector('audio#pastor-bruno');
audiop.style.display = "none"
audiop.src = '../../assets/audio/pastor_cap_1_pt2.mp3'
...
audiop.addEventListener('timeupdate', ()=>{
    audioDeterminatep.style.width = `${Math.floor(audiop.currentTime) * .6944444444444444}%`
    const totalMinutes = Math.floor(audiop.duration / 60);
    const totalSeconds = Math.floor(audiop.duration % 60);        
