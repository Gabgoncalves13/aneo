...
const audio = document.querySelector('audio#matheus_astolfo');
audio.style.display = "none"
audio.src = '../../assets/audio/matheus_cap_3_pt1.mp3'
...
audio.addEventListener('timeupdate', ()=>{
    audioDeterminate.style.width = `${Math.floor(audio.currentTime) * (Math.floor(audio.duration % 60)/100)}%`
    const totalMinutes = Math.floor(audio.duration / 60);
    const totalSeconds = Math.floor(audio.duration % 60);
...
const audiop = document.querySelector('audio#izadora-nascimento');
audiop.style.display = "none"
audiop.src = '../../assets/audio/Isadora_Cap_3.mp3'
...
audiop.addEventListener('timeupdate', ()=>{
    audioDeterminatep.style.width = `${Math.floor(audiop.currentTime) * .5813953488372093}%`
    const totalMinutes = Math.floor(audiop.duration / 60);
    const totalSeconds = Math.floor(audiop.duration % 60);
...
const audiop2 = document.querySelector('audio#mauricio_cardoso_2');
audiop2.style.display = "none"
audiop2.src = '../../assets/audio/mauricio_cap3.mp3'
...
audiop2.addEventListener('timeupdate', ()=>{
    audioDeterminatep2.style.width = `${Math.floor(audiop2.currentTime) * .6060606060606061}%`
...
const audiop3 = document.querySelector('audio#matheus_astolfo_p2');
audiop3.style.display = "none"
audiop3.src = '../../assets/audio/Matheus_cap_3_pt2.mp3'
...
audiop3.addEventListener('timeupdate', ()=>{
    audioDeterminatep3.style.width = `${Math.floor(audiop3.currentTime%60) * 1.751851851851852}%`
    console.log(Math.floor(audiop3.currentTime % 60))
    const totalMinutes = Math.floor(audiop3.duration / 60);
    const totalSeconds = Math.floor(audiop3.duration % 60);
